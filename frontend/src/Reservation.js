...
function Reservation() {
    ...
    useEffect(() => {
        ...
        if (selectedDate && isToday(selectedDate)) {
            const heuresFiltrees = heures.filter((h) => {
                ...
                // - si "lunch" : exclut les heures déjà passées
                // - si "diner" : montre toujours toutes les heures du soir
                if (service === "lunch") {
                    return heureDate > maintenant;
                } else {
                    return true; // diner → pas de filtrage
                }
            });
    ...
    return ( <
            ...
            <
            motion.div layout className = "reservation-card"
            initial = {
            ...
            <
            AnimatePresence mode = "wait" > {!confirmed && ( <
                    motion.div key = { step }
                    initial = {
                        { opacity: 0, x: 50 }
                    }
                    ...
                    transition = {
                        ...
                        step === 1 && ( <
                            Step1 {... { personnes, setPersonnes, selectedDate, setSelectedDate, service, setService, heuresDispo, selectedHeure, setSelectedHeure, setStep } }
                            />
                        )
                    }
...

                {
                    ...
                    newestOnTop = { true }
                    closeOnClick pauseOnHover draggable toastStyle = {
                        {
                            marginTop: "1rem",
                            borderRadius: "12px",
                            fontSize: "0.95rem",
                    ...
                    style = {
                        {
                            top: "0.5rem",
                            zIndex: 9999, // ✅ toujours au-dessus de la carte
                        }
                    }
                    />
